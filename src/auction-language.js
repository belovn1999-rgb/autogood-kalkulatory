...
const translations = {
  pl: {
    ...
    "auto1.historyEmpty": "Tutaj pojawi się 20 ostatnich plików.",
    ...
    "auto1.historyFavorite": "Dodaj do ulubionych",
    "auto1.historyUnfavorite": "Usuń z ulubionych",
    "auto1.historyDelete": "Usuń z historii",
    "auto1.historySaveFailed": "Nie udało się zapisać pliku w historii tej przeglądarki.",
    "auto1.savedOver": "Zapisano w miejscu oryginału: {name}. Zostaje jeden plik.",
    "auto1.savedCopy": "Ta przeglądarka nie zastępuje plików - pobrano kopię. Usuń starą wersję ręcznie.",
  ...
  ru: {
    ...
    "auto1.historyEmpty": "Здесь появятся 20 последних файлов.",
    ...
    "auto1.historyFavorite": "Добавить в избранное",
    "auto1.historyUnfavorite": "Убрать из избранного",
    "auto1.historyDelete": "Удалить из истории",
    "auto1.historySaveFailed": "Не удалось сохранить файл в истории этого браузера.",
    "auto1.savedOver": "Сохранено поверх оригинала: {name}. Остаётся один файл.",
    "auto1.savedCopy": "Этот браузер не умеет заменять файлы - скачана копия. Удалите старую версию вручную.",
